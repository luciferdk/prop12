...
import Plumber_icon from "../utils/img/pesticide.png";
import { Link } from "react-router-dom";
function PestControlers() {
	return (
		<>
			<div className={`${styles.plumbers}`}>
				<h1>Our Best Pest Controlers </h1>
